...
public class BST<E extends Comparable<E>> implements BSTInterface<E> {
    ...
    public boolean existsArea(String element){
        return findArea(root, element) != null;
    }

    public E findArea(Node<E> node, String element) {
        if (node == null) {
            return null;
        }
        if (element.compareTo(node.getElement().toString()) == 0) {
            return node.getElement();
        }
        if (element.compareTo(node.getElement().toString()) < 0) {
            return findArea(node.getLeft(), element.toString());
        }
        return findArea(node.getRight(), element.toString());
    }

    public boolean existsItem(String element){
        return findItem(root, element) != null;
    }

    public E findItem(Node<E> node, String element) {
        if (node == null) {
            return null;
        }
        if (element.compareTo(node.getElement().toString()) == 0) {
        ...
        if (element.compareTo(node.getElement().toString()) < 0) {
            return findItem(node.getLeft(), element.toString());
        }
        return findItem(node.getRight(), element.toString());
    }
    ...
    public E findElement(Node<E> node, String element) {
        if (node == null) {
            return null;
        }
        if (element.compareTo(node.getElement().toString()) == 0) {
        ...
        if (element.compareTo(node.getElement().toString()) < 0) {
            return findElement(node.getLeft(), element.toString());
        }
        return findElement(node.getRight(), element.toString());
    }

    public boolean existsYear(Integer element){
        return findYear(root, String.valueOf(element)) != null;
    }

    public E findYear(Node<E> node, String element) {
        if (node == null) {
            return null;
        }
        if (element.compareTo(node.getElement().toString()) == 0) {
        ...
        if (element.compareTo(node.getElement().toString()) < 0) {
            return findYear(node.getLeft(), element.toString());
        }
        return findYear(node.getRight(), element.toString());
    }
    /**
